...
# Configurations
# -----------------------------
MODEL_PATH = 'model-resnet50-final3.h5'  # updated for 3-class model
WINDOW_WIDTH = 800
WINDOW_HEIGHT = 600
...
def main():
    ...
    # Map model prediction index to pet type string
    pet_type_map = {0: "cat", 1: "dog", 2: "snake"}
    pet_type = pet_type_map.get(pet_class, "unknown")
